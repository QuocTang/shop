...
const Cart = () => {
  ...
  const handlClear = (priceDel)=>{
    // let newCart = [...products]
    // newCart.splice(e, 1)
    
    const totalDel = priceDel;
    return (
      // setProducts(newCart),
      console.log(products),
      dispatch(delProduct({products, quantity, totalDel})) 
    )
  }
          ...
          <Bottom>
            <Info>
              ...
              <Product>
               ...
               <RemoveBtn onClick={() => handlClear(product.price * product.quantity)}>Clear</RemoveBtn>
              </Product>))}
